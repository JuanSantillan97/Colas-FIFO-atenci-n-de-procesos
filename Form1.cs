    ...
    public partial class Form1 : Form
    {
        ...
        private void btnComenzar_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= 200; i++)
            {
                ...
                //Saber valor inicial del ciclo de un proceso.
                ...
                if (procesadorIntel.regresarInicio() != null)
                {
                    procesadorIntel.regresarInicio().disminuir();

                    if(procesadorIntel.regresarInicio().ciclos == 0)
                    {
                        txtProcesosAtendidos.Text += "Vuelta: " + i + "   " + "Inicio: " + 
                            valorCiclos + "    -->    " + procesadorIntel.eliminarPop().ToString();
                        cuantosAtendidos++;
                        cuantosAgregados--;
                        mantenerValor = true;
                    }
